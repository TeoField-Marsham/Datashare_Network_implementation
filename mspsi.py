...
def perform_ms_psi(client_elements, server_elements_per_doc):
    ...
    for doc_id, server_elements in server_elements_per_doc.items():
        ...
        # Server exponentiates client's elements with server's secret and sends them back to the client
        ...
        # Client exponentiates servers transformed elements with their secret
...
server_elements_per_doc = {
    doc_id: [hash_to_int(kwd) for kwd in keywords]
